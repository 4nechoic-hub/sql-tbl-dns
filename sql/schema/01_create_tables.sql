...
-- Schema Definition — KTH DNS Data (Schlatter & Örlü, 2010)
-- =============================================================================
-- Relational schema for wall-normal profiles of velocity statistics and
-- TKE/Reynolds stress budgets from DNS of a spatially developing ZPG
-- turbulent boundary layer at Re_theta = 670 to 4060.
--
